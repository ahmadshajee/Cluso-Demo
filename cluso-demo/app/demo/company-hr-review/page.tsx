        ...
        <div className="block-card" style={{ padding: "1.2rem" }}>
          ...
          <div className="request-list">
            {companyRequests.map((request) => {
              const isHighlighted = request._id === verifiedRequest._id;
              return (
                <div key={request._id}>
                    ...
                    <div style={{ border: "1px solid #0f766e", borderTop: "none", borderRadius: "0 0 14px 14px", padding: "1.2rem", background: "#f0fdfa" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.8rem" }}>
                        ...
                        <h4 style={{ margin: 0, fontSize: "1rem", fontWeight: 700, color: "#134e4a" }}>
                          Verification Report — {verifiedRequest.candidateName}
                        </h4>
                      </div>
                      ...
                      <div style={{ display: "grid", gap: "0.4rem", marginBottom: "1rem", fontSize: "0.88rem", color: "#334155" }}>
                        ...
                        <div><strong>Services:</strong> {verifiedRequest.selectedServices.map((s) => s.serviceName).join(", ")}</div>
                      </div>

                      <div style={{ display: "flex", gap: "0.6rem", flexWrap: "wrap" }}>
                        <button className="btn btn-primary" type="button" style={{ display: "flex", alignItems: "center", gap: "0.35rem", fontSize: "0.84rem" }}>
                        ...
                        <button className="btn btn-ghost" type="button" style={{ display: "flex", alignItems: "center", gap: "0.35rem", fontSize: "0.84rem", borderColor: "#f59e0b", color: "#92400e" }}>
