...
export default function ChecksDonePage() {
  ...
  const handleMarkVerified = () => {
    setShowDialog(false);
    setTimeout(() => router.push("/demo/report-ready"), 800);
  };
      ...
      >
        ...
        {showDialog && (
          <div className="demo-overlay" onClick={() => setShowDialog(false)}>
            <div className="demo-dialog" style={{ width: "min(600px, 95vw)" }} onClick={(e) => e.stopPropagation()}>
              ...
              <div className="demo-dialog-footer">
                ...
                <button className="btn btn-green" type="button" style={{ display: "flex", alignItems: "center", gap: "0.35rem" }} onClick={handleMarkVerified}>
